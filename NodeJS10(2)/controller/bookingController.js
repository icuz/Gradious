...
exports.getAllBookings = async (req, res) => {
    try {
        const [bookings] = await Booking.fetchAll(req.user.user_id);
...
exports.createBooking = async (req, res) => {
    ...
    try {
        const abc = req.body;
        console.log(abc);
        const { customer_name, booking_date, booking_time, total_amount, status, payment_method, duration_minutes, user_id} = abc;
