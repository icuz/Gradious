...
//     if(localStorage.getItem('jwtToken')==null || JSON.parse(localStorage.getItem('UserData')).role != "user"){
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getBookings() {
        const user_id1 = JSON.parse(localStorage.getItem('UserData')).userId;
        let userid = {
            user_id : user_id1
        }
        fetch(apiUrl, {
